<template>
  <div class="itc-register-wrap">
    <div class="register-area">
      <div class="register-logo">注册</div>
        ...
        <div class="register-form-body">
          ...
          >
            ...
            <el-form-item prop="re_user_pwd">
              <el-input
                v-model="registerForm.re_user_pwd"
                placeholder="确认密码"
                prefix-icon="el-icon-lock"
                show-password
              ></el-input>
            ...
            <el-button type="danger" class="w100" @click="submit('registerForm')" :loading="registerStatus"
              >注 册</el-button
            >
  ...
  data() {
    ...
    return {
      ...
      registerRules: {
        ...
        re_user_pwd: [{ validator: validateRepwd, trigger: 'blur' }],
        code: [
